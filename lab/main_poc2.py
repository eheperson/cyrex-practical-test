...
from locust import task, TaskSet, SequentialTaskSet, constant
import logging
...
class LoginWithUniqueUsers(SequentialTaskSet):
    email = "NOT_FOUND"
    password = "NOT_FOUND"
    tasks=[FetchVacancies]
    def on_start(self):
...
class LoginWithUniqueUsersTest(locust.GrpcUser):
    ...
    # client = auth_service_grpc.AuthServiceStub
    # @task
    # def loginUsers(self):
